    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <p class="lead text-muted">Another Blog Website</p>
          <strong>Found <?= sizeof($result);?> Blogs</strong>
        </div>
      </section>
          ...
          foreach($result as $key => $value)
          {
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" src="<?= base_url().$value['blog_img']?>" alt="No Image">
                <div class="card-body">
                  <p class="card-text"><?= $value['blog_title']?></p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="<?= base_url().'Welcome/blog_dtl/'.$value['blog_id'] ?>" class="btn btn-sm btn-outline-secondary">View</a>
                    </div>
                  </div>
                </div>
              </div>
